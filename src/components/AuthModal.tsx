          ...
          >
            ...
            <div className="p-6 space-y-4">
              ...
              <button 
                ...
                className="w-full py-2.5 px-4 rounded-xl bg-white border border-slate-200 flex items-center justify-center gap-3 text-slate-700 text-xs font-semibold hover:bg-slate-50 hover:border-slate-300 transition-colors shadow-xs"
              >
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-[10px] font-semibold text-slate-400 uppercase tracking-wider">or email access</span>
                <div className="h-px bg-slate-200 flex-1" />
              </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-white border border-slate-200 rounded-lg py-2 pl-9 pr-3 text-xs font-medium text-slate-900 focus:outline-none focus:border-teal-600 focus:ring-1 focus:ring-teal-600 transition-all"
                      required
                    />
                  </div>
                </div>
              ...
              {/* Security Footer */}
              <div className="pt-3 border-t border-slate-100 flex items-center justify-center gap-2 text-slate-400 text-[10px] font-medium">
